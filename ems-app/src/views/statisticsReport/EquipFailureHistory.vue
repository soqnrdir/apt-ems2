...
<div class="p-3">
  <div class="row">
    <div class="col-md-12">
      <h5 class="fw-bold text-start">시스템 로그</h5>
      <div class="card mt-4">
        <div class="card-body">
          <div class="row">
            <div class="col-2">
...
const tableColumns = ['일자', '오류타입', '오류내용', '대상']
export default {
  components: {
    Datepicker
  },
  ...
  watch : {
    nowsday : 'getEquipFailureList',
    nowsday2 : 'getEquipFailureList'
  },
  methods: {
    pagingReset () {
    ...
    async getEquipFailureList () {
      ...
      try {
        ...
        const res = await this.axios.get(`/v1/equipfailure/search-list?startDt=${startDt}&endDt=${endDt}`)
